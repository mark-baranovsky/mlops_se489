# Getting Started with Retail Demand Forecasting
...
**Using conda:**
```bash
conda create -n mlops_se489 python=3.11
conda activate mlops_se489
```
...
```bash
python -m mlops_se489.predict_model --model-path models/model.pkl --input data/test.csv
```
...
├── src/
│   └── mlops_se489/          # Importable package (src/ layout)
...
- Contact Stack Overflowers (aahme147@depaul.edu)
