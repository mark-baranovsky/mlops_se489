...
for col in ["product_code", "warehouse", "product_category", "order_date", "order_demand", "week_start_date"]:
...
print(f"  date range       : {df_silver['order_date'].min()} to {df_silver['order_date'].max()}")
